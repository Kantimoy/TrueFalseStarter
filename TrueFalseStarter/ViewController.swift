...
class ViewController: UIViewController {
    ...
    func displayQuestion() {
        ...
        let questionDictionary = trivia[checkRepeat()].question
    ...
    func checkRepeat() -> Int {
        ...
        // If array has the index then get new index
        if indexUsed.contains(indexOfSelectedQuestion) {
            indexOfSelectedQuestion = GKRandomSource.sharedRandom().nextInt(upperBound: trivia.count)
        }
        
        // Store the new index in array
        indexUsed.append(indexOfSelectedQuestion)
